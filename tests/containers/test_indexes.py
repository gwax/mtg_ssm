...
def test_snnma_to_id(scryfall_data: ScryfallDataSet) -> None:
    ...
    assert {
        ...
        ("isd", "Abattoir Ghoul", "85", 222911, "Volkan Baga"),
        ("isd", "Abattoir Ghoul", "85", None, "Volkan Baga"),
        ("isd", "Abattoir Ghoul", None, 222911, "Volkan Baga"),
        ("isd", "Abattoir Ghoul", None, None, "Volkan Baga"),
        ...
        (None, "Abattoir Ghoul", "85", 222911, "Volkan Baga"),
        (None, "Abattoir Ghoul", "85", None, "Volkan Baga"),
        (None, "Abattoir Ghoul", None, 222911, "Volkan Baga"),
        (None, "Abattoir Ghoul", None, None, "Volkan Baga"),
    }
